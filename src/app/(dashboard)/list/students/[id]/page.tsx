        ...
        <div className="w-full xl:w-2/3">
            ...
            <div className="flex flex-col lg:flex-row gap-4">
                ...
                <div className="bg-sky py-6 rounded-md flex-1 flex gap-4">
                    ...
                    <div className="w-1/3">
                        <Image 
                            src="https://images.pexels.com/photos/2888150/pexels-photo-2888150.jpeg?auto=compress&cs=tinysrgb&w=900" 
                            alt="" 
                            width={144} 
                            height={144} 
        ...
        <div className="w-full xl:w-1/3 flex flex-col gap-4">
            <div className="bg-white p-4 rounded-md">
                ...
                <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
                    ...
                    <Link className="p-3 rounded-md bg-yellowLight" href="/">Student&apos;s Teachers</Link>
